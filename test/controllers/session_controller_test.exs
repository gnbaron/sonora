defmodule Sonora.SessionControllerTest do
  ...
  #     json_response(conn, 401)
  #   end
  #   assert_raise(Sonora.Exceptions.MissingParamError,
  #     "Fields [email, password] can't be blank", fn -> tryLogin.(%{}) end)
  #   assert_raise(Sonora.Exceptions.MissingParamError,
  #     "Fields [email, password] can't be blank", fn -> tryLogin.(%{email: "", password: ""}) end)
  #   assert_raise(Sonora.Exceptions.MissingParamError,
  #     "Field password can't be blank", fn -> tryLogin.(%{email: "p@p.com", password: ""}) end)
  # end
  #
  # test "logout" do
  #   user = create(:user)
